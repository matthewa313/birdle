  ...
  return (
    <BaseModal title="How to Play Birdle" isOpen={isOpen} handleClose={handleClose}>
      ...
      <div className="flex justify-center mb-1 mt-4">
        <Cell value="B" isRevealing={true} isCompleted={true} status="correct" />
        <Cell value="E" />
        <Cell value="A" />
        <Cell value="K" />
        <Cell value="S" />
      ...
      <div className="flex justify-center mb-1 mt-4">
        <Cell value="R" />
        <Cell value="A" />
        <Cell value="V" isRevealing={true} isCompleted={true} status="present" />
        <Cell value="E" />
        <Cell value="N" />
      </div>
      <p className="text-sm text-gray-500 dark:text-gray-300">
      ...
      <p className="mt-6 italic text-sm text-gray-500 dark:text-gray-300">
        Concept by Steele Billings. Code by Matthew Anderson.
      </p>
    </BaseModal>
  )
}
